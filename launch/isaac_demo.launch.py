...
def generate_launch_description():
    ...
    # static transform would work for now
    ...
    # ros2_control using the robot_description topic from robot_state_publisher
    ...
    bcr_arm_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
